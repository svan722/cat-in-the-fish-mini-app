    ...
    return (
        <div className="flex flex-col items-center w-screen h-screen pt-[23px] pb-[29px] px-[17px]">
            <div className="flex items-center gap-[5px] mx-auto">
                <button onClick={handleVolume} className={`w-[45px] h-[45px] border border-[#C6F0FF85] rounded-full bg-gradient-to-b from-[#38AFE3B0] to-[#1E94D3B0] flex items-center justify-center hover:-translate-y-1 hover:active:translate-y-0 transition-all duration-200 ${ muted ? 'fill-red-400' : 'fill-white'}`}>

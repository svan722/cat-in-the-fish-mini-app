...
const Invite = () => {
    ...
    return (
        <div className="flex flex-col h-[100vh]">
            ...
            <div className="fixed bottom-0 w-full h-[79px] grid grid-cols-4 items-center justify-center px-[20px] rounded-[16px] bg-[#8AA6B799] backdrop-blur-md">
                <Link to="/" className="flex flex-col items-center gap-[4px] fill-white hover:scale-125 transition-all duration-200">
                    ...
                    <span className="text-[10px] text-white leading-none">HOME</span>
                </Link>
                ...
                <Link to="/invite" className="flex flex-col items-center gap-[4px] group fill-primary transition-all duration-200 hover:scale-125 hover:active:scale-100">
                    ...
                    <span className="text-[10px] text-primary leading-none transition-all duration-200">FRIEND</span>
                </Link>
            </div>
        </div>
    )
